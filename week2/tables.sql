...
INSERT INTO `wsp_cat` (`cat_id`, `name`, `weight`, `owner`, `filename`, `birthdate`) VALUES
...
INSERT INTO `wsp_user` (`user_id`, `name`, `email`, `password`, `role`) VALUES
...
ALTER TABLE `wsp_cat`
  ADD CONSTRAINT `wsp_cat_ibfk_1` FOREIGN KEY (`owner`) REFERENCES `wsp_user` (`user_id`) ON DELETE CASCADE;
